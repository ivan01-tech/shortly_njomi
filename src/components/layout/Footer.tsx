    ...
    <footer className="bg-very-dark-violet md:py-10 py-4">
      <div className=" flex flex-col items-center md:items-start text-white gap-8 md:flex-row max_width md:justify-start">
        ...
        <section className="flex text-left md:mr-6 flex-col gap-4 align-baseline">
          <h4 className="text-2xl font-bold capitalize">features</h4>
        ...
        <section className="flex text-left md:mr-6 flex-col gap-4">
          <h4 className="text-2xl font-bold capitalize">Resources</h4>
          <ul className="flex flex-col gap-2 text-gray">
            <li>
              <a className="hover:text-primary-cyan" href="/">
                Blog
        ...
        <section className="flex text-left md:mr-6 flex-col gap-4">
          <h4 className="text-2xl font-bold capitalize">Company</h4>
          <ul className="flex flex-col gap-2 text-gray">
            <li>
              <a className="hover:text-primary-cyan" href="/">
                About
        ...
        <div className="flex justify-center gap-4 text-3xl my-6 text-white md:flex-1">
          <a className="hover:text-primary-cyan" href="/">
